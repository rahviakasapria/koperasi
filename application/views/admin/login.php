...
<div class="login-box">
	...
	<h1 class="text-bold">Koperasi</h1>
		<a href="<?php echo base_url('Auth')?>"><b>KSU Manggar Tuwuh</b></a>
	</div>
		...
		<form action="<?php echo base_url('Auth/login')?>" method="post">
			...
			<div class="form-group has-feedback">
				...
				<div class="custom-control custom-control-alternative custom-checkbox">
                    <span class="text-bold">Keterangan Login</span>
                    <br>
					<li class="user-header">
                    <span class="text-muted">username : ilham</span>
                    <br>
					<li class="user-header">
                    <span class="text-muted">password : 1234</span>
                  </label>
                </div>
			...
			<div class="row">
				...
				<div class="col-xs-4 pull-right">
					<a href="<?php echo  base_url('Auth/add')?>" class="btn btn-success btn-block">
						<span class="fa"></span> Register</a>
				</div>
				<!-- /.col -->
			</div>
