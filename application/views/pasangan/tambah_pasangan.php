  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-fw fa-user-plus"></i> Pasangan</a></li>
          <li><a href="<?php echo base_url('Anggota_controller/index') ?>">Lihat Data Pasangan</a></li>
          <li><a href="<?php echo base_url('Anak_controller/form/'.$anggota->id_anggota) ?>">Tambah Data Pasangan</a></li>
        </ol>
      </section>
            ...
            <div class="box box-primary">
              ...
              <form role="form" action="<?php echo base_url('Pasangan_controller/add/'.$anggota->id_anggota) ?>" method="post">
                ...
                <div class="box-footer">
                  ...
                  <a href="<?php echo  base_url('Anggota_controller')?>" class="btn btn-danger" ><i class="fa fa-fw fa-times"></i>Batal</a>
                </div>
              </form>
