  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <a href="<?php echo  base_url('/Angsuran_controller')?>" class="btn btn-danger">Kembali</a>
      </ol>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url('Angsuran_controller/edit/'.$angsuran->id_angsuran) ?>" method="post">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo  base_url('Angsuran_controller')?>" class="btn btn-danger" ><i class="fa fa-fw fa-times"></i>Batal</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
